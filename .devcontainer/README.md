...
If you want a faster and easier demo experience with Primeagent, download and install [Primeagent Desktop](https://docs.primeagent.org/get-started-installation#install-and-run-primeagent-desktop) for the least complicated setup experience.
