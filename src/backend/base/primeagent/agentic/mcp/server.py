"""FastMCP server for Primeagent Agentic tools.
...
from primeagent.agentic.utils.flow_component import (
    get_component_details,
    get_component_field_value,
    list_component_fields,
    update_component_field_value,
)
from primeagent.agentic.utils.flow_graph import (
    get_flow_ascii_graph,
    get_flow_graph_representations,
    get_flow_graph_summary,
    get_flow_text_repr,
)
from primeagent.agentic.utils.template_create import (
    create_flow_from_template_and_get_link,
)
from primeagent.agentic.utils.template_search import (
    get_all_tags,
    get_template_by_id,
    get_templates_count,
    list_templates,
