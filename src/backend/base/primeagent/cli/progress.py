...
def create_primeagent_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Primeagent initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Primeagent", "Setting up basic configuration"),
        ...
        ("Launching Primeagent", "Starting server and final setup"),
    ]
...
def create_primeagent_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Primeagent shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
