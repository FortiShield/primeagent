...
from primeagent.services.job_queue.service import JobQueueService  # noqa: TC001
from primeagent.services.storage.service import StorageService  # noqa: TC001
from primeagent.services.telemetry.service import TelemetryService  # noqa: TC001
...
def get_service(service_type: ServiceType, default=None):
    ...
    if not service_manager.are_factories_registered():
        ...
        from primeagent.services.manager import ServiceManager
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from primeagent.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from primeagent.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from primeagent.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from primeagent.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from primeagent.services.variable.factory import VariableServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from primeagent.services.database.factory import DatabaseServiceFactory
...
async def session_scope() -> AsyncGenerator[AsyncSession, None]:
    ...
    """
    from wfx.services.deps import session_scope as wfx_session_scope

    async with wfx_session_scope() as session:
        yield session
...
def get_session_service() -> SessionService:
    ...
    """
    from primeagent.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from primeagent.services.task.factory import TaskServiceFactory
...
def get_queue_service() -> JobQueueService:
    ...
    from primeagent.services.job_queue.factory import JobQueueServiceFactory
