...
class CollectingSpanProcessor(SpanProcessor):
    ...
    def on_start(self, span, parent_context=None):
        ...
        if span.name in ("Primeagent", "Language Model"):
            span.set_attribute("primeagent.correlation_id", self.correlation_id)
...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("primeagent.trace_name", self.trace_name)
            self.root_span.set_attribute("primeagent.trace_type", self.trace_type)
            self.root_span.set_attribute("primeagent.project_name", self.project_name)
            self.root_span.set_attribute("primeagent.trace_id", str(self.trace_id))
            self.root_span.set_attribute("primeagent.session_id", str(self.session_id))
            self.root_span.set_attribute("primeagent.flow_name", self.flow_name)
            self.root_span.set_attribute("primeagent.flow_id", self.flow_id)
