...
from primeagent.api.v2.converters import (
...
from primeagent.services.deps import get_job_service, get_task_service
...
async def execute_sync_workflow(
    ...
    # Headers with prefix X-PRIMEAGENT-GLOBAL-VAR-* are extracted and made available to components
