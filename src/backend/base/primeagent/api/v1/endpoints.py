...
async def _run_flow_internal(
    *,
    ...
    # Extract request-level variables from headers with prefix X-PRIMEAGENT-GLOBAL-VAR-*
...
async def simplified_run_flow(
    *,
    ...
    Notes:
        ...
        - Extracts global variables from HTTP headers with prefix X-PRIMEAGENT-GLOBAL-VAR-*
...
# get endpoint to return version of primeagent
@router.get("/version")
