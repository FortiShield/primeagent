...
from primeagent.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from primeagent.schema.content_types import ToolContent
from primeagent.services.auth.utils import api_key_security
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert Primeagent events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified Primeagent flow.
    ...
    # Extract global variables from X-PRIMEAGENT-GLOBAL-VAR-* headers
