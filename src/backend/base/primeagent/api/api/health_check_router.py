...
# it means uvicorn's /health serves first before the primeagent instance is up
# therefore it's not a reliable health check for a primeagent instance
...
# It's a reliable health check for a primeagent instance
