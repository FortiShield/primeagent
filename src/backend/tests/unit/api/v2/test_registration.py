...
from primeagent.api.v2.registration import (
    RegisterRequest,
    RegisterResponse,
...
class TestHelperFunctions:
    ...
    @patch("primeagent.api.v2.registration.REGISTRATION_FILE")
    ...
    @patch("primeagent.api.v2.registration._ensure_registration_file")
...
class TestAPIEndpoints:
    ...
    @pytest.mark.asyncio
    @patch("primeagent.api.v2.registration.save_registration")
...
class TestIntegration:
    ...
    def test_full_registration_flow(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("primeagent.api.v2.registration.REGISTRATION_FILE", test_file)
