...
class TestProjectMCPIntegration:
    ...
    async def test_create_project_with_mcp_auto_add_enabled_success(
        ...
        with (
            ...
            patch("primeagent.api.v1.projects.get_project_streamable_http_url") as mock_streamable_url,
    ...
    async def test_update_project_name_with_mcp_server_update(
        ...
        with (
            patch("primeagent.api.v1.projects.get_settings_service") as mock_get_settings,
            patch("primeagent.api.v1.projects.get_project_streamable_http_url"),
...
async def test_download_file_starter_project(client: AsyncClient, logged_in_headers, active_user, json_flow):
    ...
    project_payload = {
        ...
        "description": "Starter projects to help you get started in Primeagent.",
        "flows_list": [],
        "components_list": [],
    }
