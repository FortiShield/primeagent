...
from wfx.base.datastax import AstraDBBaseComponent
...
class TestCloudProviderMapping:
    ...
    @patch("wfx.base.datastax.astradb_base.DataAPIClient")
...
class TestCollectionCreation:
    ...
    @pytest.mark.asyncio
    @patch("wfx.base.datastax.astradb_base._AstraDBCollectionEnvironment")
