...
from wfx.components.langchain_utilities.csv_agent import CSVAgentComponent
from wfx.components.langchain_utilities.json_agent import JsonAgentComponent
...
class TestS3CompatibleComponents:
    ...
    async def test_file_component_get_local_file_for_docling_local(self, local_settings):
        ...
        with patch("wfx.services.deps.get_settings_service", return_value=local_settings):
            component = FileComponent()
    ...
    async def test_save_file_component_s3_upload(self, s3_settings):
        ...
        with (
            patch("wfx.services.deps.get_settings_service", return_value=s3_settings),
            ...
            with (
                ...
                # Test with DataFrame
                from primeagent.schema import Data, DataFrame
    ...
    async def test_components_work_in_local_mode(self, local_settings):
        ...
        with patch("primeagent.services.deps.get_settings_service", return_value=local_settings):
            component = FileComponent()
    ...
    async def test_csv_to_data_fileinput_local_only(self, s3_settings, local_settings):
        ...
        from wfx.components.data_source.csv_to_data import CSVToDataComponent
    ...
    async def test_json_to_data_fileinput_local_only(self, s3_settings, local_settings):
        ...
        from wfx.components.data_source.json_to_data import JSONToDataComponent
