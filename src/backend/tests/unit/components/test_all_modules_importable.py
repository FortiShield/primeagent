...
class TestAllModulesImportable:
    ...
    def test_backward_compatibility_imports(self):
        ...
        traditional_imports = [
            ...
            ("primeagent.components.models_and_agents", "AgentComponent"),
...
class TestDirectModuleImports:
    ...
    @pytest.mark.asyncio
    async def test_all_wfx_component_modules_directly_importable(self):
        """Test that all wfx component modules can be directly imported.
        ...
        try:
            ...
            pytest.skip("wfx.components not available")
    ...
    def test_no_deprecated_langchain_imports(self):
        ...
        try:
            ...
            wfx_path = Path(wfx.__file__).parent
        except ImportError:
            pytest.skip("wfx package not found")

        components_path = wfx_path / "components"
        if not components_path.exists():
            pytest.skip("wfx.components directory not found")
                    ...
                    if isinstance(node, ast.ImportFrom):
                        ...
                        for deprecated, replacement in deprecated_patterns:
                            if module.startswith(deprecated):
                                relative_path = py_file.relative_to(wfx_path)
    ...
    async def test_vector_store_components_directly_importable(self):
        ...
        vector_store_components = [
            ("wfx.components.chroma", "ChromaVectorStoreComponent"),
            ("wfx.components.pinecone", "PineconeVectorStoreComponent"),
            ("wfx.components.qdrant", "QdrantVectorStoreComponent"),
            ("wfx.components.weaviate", "WeaviateVectorStoreComponent"),
            ("wfx.components.vectorstores", "LocalDBComponent"),
        ]
    ...
    def test_qdrant_component_directly_importable(self):
        ...
        """
        try:
            from wfx.components.qdrant import QdrantVectorStoreComponent
