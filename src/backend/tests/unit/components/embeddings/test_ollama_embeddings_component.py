...
import pytest
from wfx.components.ollama.ollama_embeddings import OllamaEmbeddingsComponent
...
class TestOllamaEmbeddingsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("wfx.components.ollama.ollama_embeddings.OllamaEmbeddings")
    ...
    @patch("wfx.components.ollama.ollama_embeddings.OllamaEmbeddings")
    @patch("wfx.components.ollama.ollama_embeddings.logger")
    ...
    @pytest.mark.asyncio
    @patch("wfx.components.ollama.ollama_embeddings.httpx.AsyncClient.post")
    @patch("wfx.components.ollama.ollama_embeddings.httpx.AsyncClient.get")
