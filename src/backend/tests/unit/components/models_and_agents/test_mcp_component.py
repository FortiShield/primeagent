...
import pytest
from wfx.base.mcp.util import MCPSessionManager, MCPStdioClient, MCPStreamableHttpClient
from wfx.components.models_and_agents.mcp_component import MCPToolsComponent
...
class TestMCPComponentConfigPriority:
    ...
    async def test_database_config_takes_priority_over_value(self, component):
        ...
        with (
            ...
            patch("wfx.components.models_and_agents.mcp_component.session_scope"),
...
def test_resolve_config_db_takes_priority():
    ...
    from wfx.components.models_and_agents.mcp_component import resolve_mcp_config
...
async def test_config_priority_with_fixtures(mock_db_session_with_servers):
    ...
    with (
        ...
        patch("primeagent.services.database.models.user.crud.get_user_by_id") as mock_get_user,
        patch(
            "wfx.components.models_and_agents.mcp_component.session_scope",
