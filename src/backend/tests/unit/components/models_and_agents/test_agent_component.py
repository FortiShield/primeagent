...
from wfx.base.models.openai_constants import (
...
class TestAgentComponent(ComponentTestBaseWithoutClient):
    ...
    async def test_agent_filters_empty_chat_history_messages(self):
        ...
        from wfx.base.agents.utils import data_to_messages
    ...
    async def test_get_agent_requirements_passes_watsonx_params(self, component_class, default_kwargs):
        ...
        with patch("wfx.components.models_and_agents.agent.get_llm") as mock_get_llm:
    ...
    @patch("wfx.components.models_and_agents.agent.AgentComponent.get_memory_data")
    @patch("wfx.components.models_and_agents.agent.get_llm")
