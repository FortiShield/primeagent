...
import pytest
from wfx.base.embeddings.embeddings_class import EmbeddingsWithModels
from wfx.components.models_and_agents import EmbeddingModelComponent
...
class TestEmbeddingModelComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("wfx.components.models_and_agents.embedding_model.get_unified_models_detailed")
