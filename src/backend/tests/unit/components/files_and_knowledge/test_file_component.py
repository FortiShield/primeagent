...
class TestFileComponentToolMode:
    ...
    @patch("wfx.base.data.cloud_storage_utils.create_s3_client")
    @patch("wfx.base.data.cloud_storage_utils.validate_aws_credentials")
    ...
    @patch("wfx.base.data.cloud_storage_utils.create_google_drive_service")
