...
from wfx.base.models.ollama_constants import DEFAULT_OLLAMA_API_URL
...
class TestChatOllamaComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("wfx.components.ollama.ollama.ChatOllama")
    ...
    @pytest.mark.asyncio
    @patch("wfx.components.ollama.ollama.httpx.AsyncClient.post")
    @patch("wfx.components.ollama.ollama.httpx.AsyncClient.get")
    ...
    @patch("wfx.components.ollama.ollama.ChatOllama")
    @patch("wfx.components.ollama.ollama.logger")
