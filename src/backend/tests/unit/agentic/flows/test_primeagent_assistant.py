"""Tests for PrimeagentAssistant flow.
...
class TestGetGraph:
    ...
    def test_should_create_graph_with_default_provider(self):
        ...
        with (
            patch("primeagent.agentic.flows.primeagent_assistant.ChatInput") as mock_chat_input,
            patch("primeagent.agentic.flows.primeagent_assistant.ChatOutput") as mock_chat_output,
            patch("primeagent.agentic.flows.primeagent_assistant.LanguageModelComponent") as mock_llm,
            patch("primeagent.agentic.flows.primeagent_assistant.Graph"),
        ):
    ...
    def test_should_use_provided_provider_and_model(self):
        ...
        with (
            patch("primeagent.agentic.flows.primeagent_assistant.ChatInput"),
            patch("primeagent.agentic.flows.primeagent_assistant.ChatOutput"),
            patch("primeagent.agentic.flows.primeagent_assistant.LanguageModelComponent") as mock_llm,
            patch("primeagent.agentic.flows.primeagent_assistant.Graph"),
        ):
            mock_llm_instance = MagicMock()
    ...
    def test_should_configure_chat_input(self):
        ...
        with (
            patch("primeagent.agentic.flows.primeagent_assistant.ChatInput") as mock_chat_input,
            patch("primeagent.agentic.flows.primeagent_assistant.ChatOutput"),
            patch("primeagent.agentic.flows.primeagent_assistant.LanguageModelComponent"),
            patch("primeagent.agentic.flows.primeagent_assistant.Graph"),
        ):
    ...
    def test_should_create_graph_with_start_and_end(self):
        ...
        with (
            ...
            patch("primeagent.agentic.flows.primeagent_assistant.ChatOutput") as mock_chat_output,
            patch("primeagent.agentic.flows.primeagent_assistant.LanguageModelComponent"),
            patch("primeagent.agentic.flows.primeagent_assistant.Graph") as mock_graph_class,
        ):
...
class TestAssistantPrompt:
    ...
    def test_should_contain_code_requirements(self):
        ...
        assert "wfx.custom" in ASSISTANT_PROMPT or "primeagent.custom" in ASSISTANT_PROMPT
