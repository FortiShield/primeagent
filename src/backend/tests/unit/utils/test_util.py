...
class TestBuildTemplateFromFunction:
    ...
    @patch("wfx.utils.util.parse")
    @patch("wfx.utils.util.get_default_factory")
    ...
    def test_add_function_base_class(self):
        ...
        with (
            patch("wfx.utils.util.parse") as mock_parse,
            patch("wfx.utils.util.get_base_classes") as mock_get_base_classes,
            patch("wfx.utils.util.format_dict") as mock_format_dict,
        ):
...
class TestFormatDict:
    ...
    def test_format_dict_basic(self):
        ...
        with (
            patch("wfx.utils.util.get_type") as mock_get_type,
            patch("wfx.utils.util.should_show_field") as mock_show,
            patch("wfx.utils.util.is_password_field") as mock_password,
            patch("wfx.utils.util.is_multiline_field") as mock_multiline,
        ):
...
class TestUtilityFunctions:
    ...
    def test_add_options_to_field(self):
        ...
        with patch("wfx.utils.util.constants") as mock_constants:
...
class TestUpdateSettings:
    ...
    @pytest.mark.asyncio
    @patch("wfx.utils.util.get_settings_service")
