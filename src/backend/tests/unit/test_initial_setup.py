...
@pytest.mark.parametrize(
    ...
    [
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/refs/heads/main.zip",
        ),
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles/",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/refs/heads/main.zip",
        ...
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles.git",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/refs/heads/main.zip",
        ),
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles/tree/some.branch-0_1",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/refs/heads/some.branch-0_1.zip",
        ),
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles/tree/some/branch",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/refs/heads/some/branch.zip",
        ),
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles/tree/some/branch/",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/refs/heads/some/branch.zip",
        ...
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles/releases/tag/v1.0.0-0_1",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/refs/tags/v1.0.0-0_1.zip",
        ),
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles/releases/tag/foo/v1.0.0",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/refs/tags/foo/v1.0.0.zip",
        ),
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles/releases/tag/foo/v1.0.0/",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/refs/tags/foo/v1.0.0.zip",
        ...
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles/commit/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9.zip",
        ),
        (
            "https://github.com/khulnasoft-bot/primeagent-bundles/commit/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9/",
            "https://github.com/khulnasoft-bot/primeagent-bundles/archive/68428ce16729a385fe1bcc0f1ec91fd5f5f420b9.zip",
...
def profile_pictures_temp_config(monkeypatch):
    ...
    monkeypatch.setenv("PRIMEAGENT_CONFIG_DIR", str(config_path))
...
async def test_copy_profile_pictures_source_exists():
    ...
    from primeagent.initial_setup import setup
...
async def test_copy_profile_pictures_handles_missing_config_dir():
    ...
    with patch("primeagent.initial_setup.setup.get_storage_service") as mock_storage:
