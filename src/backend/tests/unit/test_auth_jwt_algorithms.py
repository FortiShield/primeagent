...
class TestAuthSettingsAlgorithms:
    ...
    def test_custom_private_key_derives_public_key(self):
        ...
        from wfx.services.settings.auth import AuthSettings
        from wfx.services.settings.utils import generate_rsa_key_pair
...
class TestTokenCreation:
    ...
    def test_create_token_hs256(self):
        ...
        from primeagent.services.auth.utils import create_token
...
class TestAuthenticationFailures:
    ...
    async def test_missing_secret_key_hs256_raises_401(self):
        ...
        from primeagent.services.auth.service import AuthService
        from primeagent.services.auth.utils import get_current_user_from_access_token
        from wfx.services.settings.auth import JWTAlgorithm
...
class TestRefreshTokenVerification:
    ...
    async def test_refresh_token_rs256_success(self):
        ...
        from primeagent.services.auth.service import AuthService
        from primeagent.services.auth.utils import create_refresh_token, create_token
...
class TestJWTKeyHelpers:
    ...
    def test_get_jwt_verification_key_hs256_returns_secret_key(self):
        ...
        from primeagent.services.auth.utils import get_jwt_verification_key
    ...
    def test_get_jwt_verification_key_missing_public_key_raises_error(self):
        ...
        from primeagent.services.auth.utils import JWTKeyError, get_jwt_verification_key
    ...
    def test_get_jwt_signing_key_hs256_returns_secret_key(self):
        ...
        from primeagent.services.auth.utils import get_jwt_signing_key
