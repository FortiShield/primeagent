...
from wfx.cli.serve_app import FlowMeta, StreamRequest, create_multi_serve_app
...
def multi_serve_app(mock_graphs, mock_metas, monkeypatch):
    ...
    with patch("wfx.cli.serve_app.execute_graph_with_capture") as mock_execute:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from wfx.cli.serve_app import verify_api_key
...
class TestMultiServeStreaming:
    ...
    async def test_regular_run_endpoint_still_works(self, multi_serve_app, mock_api_key):
        ...
        with patch("wfx.cli.serve_app.extract_result_data") as mock_extract:
