...
from wfx.template.utils import update_frontend_node_with_template_values
from wfx.type_extraction import post_process_type
...
if TYPE_CHECKING:
    ...
    from wfx.schema.schema import OutputValue
    from wfx.services.storage.service import StorageService
...
class CustomComponent(BaseComponent):
    ...
    def tracing_service(self):
        ...
        if self._tracing_service is None:
            from wfx.services.deps import get_tracing_service
