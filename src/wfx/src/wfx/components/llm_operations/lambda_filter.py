...
from wfx.io import DataInput, IntInput, ModelInput, MultilineInput, Output, SecretStrInput
...
class LambdaFilterComponent(Component):
    ...
    documentation: str = "https://docs.agent.khulnasoft.com/smart-transform"
