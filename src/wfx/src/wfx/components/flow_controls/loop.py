from wfx.base.flow_controls.loop_utils import (
    execute_loop_body,
    extract_loop_output,
...
from wfx.components.processing.converter import convert_to_data
...
class LoopComponent(Component):
    ...
    documentation: str = "https://docs.agent.khulnasoft.com/loop"
    icon = "infinity"
