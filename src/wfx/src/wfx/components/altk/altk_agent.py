...
class ALTKAgentComponent(ALTKBaseAgentComponent):
    ...
    documentation: str = "https://docs.agent.khulnasoft.com/bundles-altk"
    icon = "zap"
    beta = True
    name = "ALTK Agent"
