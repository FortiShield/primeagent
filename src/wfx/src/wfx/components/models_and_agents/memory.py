...
from wfx.helpers.data import data_to_text
from wfx.inputs.inputs import DropdownInput, HandleInput, IntInput, MessageTextInput, MultilineInput, TabInput
from wfx.memory import aget_messages, astore_message
...
from wfx.utils.component_utils import set_current_fields, set_field_display
from wfx.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_USER


class MemoryComponent(Component):
    display_name = "Message History"
    description = "Stores or retrieves stored chat messages from Primeagent tables or an external memory."
    documentation: str = "https://docs.agent.khulnasoft.com/message-history"
