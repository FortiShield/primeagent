"""Default auth service for WFX (no database/JWT; use Primeagent auth for full auth)."""
...
class AuthService(BaseAuthService):
    """Default WFX auth service.

    No database, JWT, or API key validation. For full auth, configure
    auth_service = "primeagent.services.auth.service:AuthService" in wfx.toml.
    """
