...
GROQ_MODELS_DETAILED = [
    ...
    create_model_metadata(provider="Groq", name="gemma2-9b-it", icon="Groq", deprecated=True),  # Google - Removed
    create_model_metadata(provider="Groq", name="gemma-7b-it", icon="Groq", deprecated=True),  # Google
    create_model_metadata(provider="Groq", name="llama3-70b-8192", icon="Groq", deprecated=True),  # Meta - Removed
    create_model_metadata(provider="Groq", name="llama3-8b-8192", icon="Groq", deprecated=True),  # Meta - Removed
    ...
    create_model_metadata(provider="Groq", name="llama-3.2-1b-preview", icon="Groq", deprecated=True),  # Meta - Removed
    create_model_metadata(provider="Groq", name="llama-3.2-3b-preview", icon="Groq", deprecated=True),  # Meta - Removed
    ...
    create_model_metadata(provider="Groq", name="qwen-2.5-32b", icon="Groq", deprecated=True),  # Alibaba - Removed
    ...
    create_model_metadata(provider="Groq", name="llama-3.1-70b-versatile", icon="Groq", deprecated=True),  # Meta
    create_model_metadata(provider="Groq", name="mixtral-8x7b-32768", icon="Groq", deprecated=True),  # Mistral
    # ===== UNSUPPORTED MODELS =====
