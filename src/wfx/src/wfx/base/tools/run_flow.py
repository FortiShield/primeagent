...
from primeagent.helpers.flow import get_flow_by_id_or_name
...
# TODO: switch to wfx
from wfx.helpers import get_flow_inputs, run_flow
from wfx.inputs.inputs import BoolInput, DropdownInput, InputTypes, MessageTextInput, StrInput
from wfx.log.logger import logger
from wfx.schema.data import Data
from wfx.schema.dotdict import dotdict
from wfx.services.cache.utils import CacheMiss
from wfx.services.deps import get_shared_component_cache_service
...
class RunFlowBaseComponent(Component):
    ...
    def _process_tweaks_on_graph(self, graph: Graph, tweaks: dict[str, dict[str, Any]]):
        # there is a bug with the wfx process_tweaks_on_graph function
