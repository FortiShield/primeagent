...
from wfx.base.prompts.utils import dict_values_to_string
from wfx.log.logger import logger
from wfx.schema.content_block import ContentBlock
from wfx.schema.content_types import ErrorContent
from wfx.schema.data import Data
from wfx.schema.image import Image, get_file_paths, is_image_file
from wfx.schema.properties import Properties, Source
from wfx.schema.validators import timestamp_to_str, timestamp_to_str_validator
from wfx.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_NAME_USER, MESSAGE_SENDER_USER
from wfx.utils.image import create_image_content_dict
from wfx.utils.mustache_security import safe_mustache_render
...
class Message(Data):
    ...
    def to_dataframe(self) -> DataFrame:
        from wfx.schema.dataframe import DataFrame  # Local import to avoid circular import
