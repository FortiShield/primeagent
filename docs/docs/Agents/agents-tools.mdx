...
By default, [Primeagent agents](/agents) only include the functionality built-in to their base LLM.
...
2. Enter Python code into the **Code** pane to create the custom component.
    ...
    class TextAnalyzerComponent(Component):
        ...
        documentation: str = "http://docs.agent.khulnasoft.com/components/custom"
        icon = "chart-bar"
...
Primeagent supports **Tool Mode** for the following data types:
