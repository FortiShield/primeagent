...
Follow these best practices when submitting a template to Primeagent.

For template formatting examples, see [`/starter_projects`](https://github.com/khulnasoft-bot/primeagent/tree/main/src/backend/base/primeagent/initial_setup/starter_projects) in the Primeagent repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [Primeagent repository](https://github.com/khulnasoft-bot/primeagent) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main Primeagent repository.
5. Include a screenshot of your template in the PR.

The Primeagent team will review your PR, offer feedback, and, if approved, merge the template.
...
Don't use custom components that aren't part of the Primeagent codebase.
...
For more information, see the Primeagent repository's [template categories](https://github.com/khulnasoft-bot/primeagent/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).
