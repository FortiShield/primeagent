...
To use the **Ollama** component in a flow, connect Primeagent to your locally running Ollama server and select a model:
...
To use this component in a flow, connect Primeagent to your locally running Ollama server and select an embeddings model:
