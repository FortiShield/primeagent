...
Primeagent's **Agent** component is critical for building agent flows.
...
- [Use Primeagent as an MCP client](/mcp-client) and [Use Primeagent as an MCP server](/mcp-server): Use the **Agent** and [**MCP Tools** component](/mcp-tools) to implement the Model Context Protocol (MCP) in your flows.
...
You can connect any Primeagent component as a tool, including other **Agent** components and MCP servers through the [**MCP Tools** component](/mcp-tools).
