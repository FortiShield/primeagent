...
description: Use CometAPI models in Primeagent to generate text or output a Language Model for downstream Components.
---

import Icon from '@site/src/components/icon';

[Bundles](/components-bundle-components) contain custom components that support specific third-party integrations with Primeagent.
...
3. In Primeagent, add the **CometAPI** component to your flow.
