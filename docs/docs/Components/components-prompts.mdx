...
Variables in a **Prompt Template** component dynamically add fields to the **Prompt Template** component so that your flow can receive definitions for those values from other components, Primeagent global variables, or fixed input.
...
4. Provide input for the variable fields:
   ...
   - Use Primeagent global variables.
