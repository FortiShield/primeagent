...
:::tip
The ALTK contains features called _components_. These are different from Primeagent components. All components within ALTK are available through Primeagent's **ALTK Agent** component.
:::
...
For an example of the ALTK component in Primeagent, see the video tutorial [ALTK in Primeagent: Reliably handle JSON responses in your AI agent](https://www.youtube.com/watch?v=YNwPBK_KxXY).
