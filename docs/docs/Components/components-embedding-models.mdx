...
Embedding model components in Primeagent generate text embeddings using a specified Large Language Model (LLM).

Primeagent includes an **Embedding Model** core component that has built-in support for some LLMs.
