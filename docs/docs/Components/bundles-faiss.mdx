...
| ------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------- |
| index_name                      | String     | Input parameter. The name of the FAISS index. Default: "primeagent_index".                            |
| persist_directory               | String     | Input parameter. Path to save the FAISS index. It is relative to where Primeagent is running.         |
